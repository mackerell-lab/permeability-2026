...
# Read the file
df = pd.read_csv("../data/POPC-CHOL/non-biogen-ligands/lgfe/full_data/ligands_including_protomers.csv")
...
plt.tight_layout()
plt.savefig("protomer_distribution_non_biogen.png", dpi=300, bbox_inches="tight")
plt.close()
