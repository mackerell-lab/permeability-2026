...
namespace eval ::silcs:: {
    ...
    variable fragmaps_available {
        ...
        benc {
            label "Benzene Carbon"
            color 11 # purple
            visible 0
            cutoff -1.2
        }
        prpc {
            label "Propane Carbon"
            color 12 # green
            visible 0
            cutoff -1.2
        }
        meoo {
            label "Methanol Oxygen"
            color 5 # tan
            visible 0
            cutoff -0.8
        }
        forn {
            label "Formamide Nitrogen"
            color 0 # blue
            visible 0
            cutoff -1.2
        }
        foro {
            label "Formamide Oxygen"
            color 1 # red
            visible 0
            cutoff -1.2
        }
        ...
        gehc {
            label "Generic Heterocycle Carbon"
            color 25 # violet
            visible 0
            cutoff -1.2
        }
        ...
        clbx {
            label "Chlorobenzene Chlorine"
            color 9 # pink
            visible 0
            cutoff -1.2
        }
        flbx {
            label "Fluorobenzene Fluorine"
            color 15 # iceblue
            visible 0
            cutoff -1.2
        }
        brbx {
            label "Bromobenzene Bromine"
            color 14 # ochre
            visible 0
            cutoff -1.2
        }
        clex {
            label "Chloroethane Chlorine"
            color 19 # green2
            visible 0
            cutoff -1.2
        }
        fetx {
            label "Fluoroethane Fluorine"
            color 20 # green3
            visible 0
            cutoff -1.2
        }
        tfec {
            label "Trifluoroethane Carbon"
            color 12 # lime
            visible 0
            cutoff -1.2
        }
        dmeo {
            label "Dimethylether Oxygen"
            color 29 # red2
            visible 0
            cutoff -1.2
        }
        ...
        asnn {
            label "Asparagine ND2"
            color 0 # blue
            visible 0
            cutoff 0.075
        }
        asno {
            label "Asparagine OD1"
            color 1 # red
            visible 0
            cutoff 0.075
        }
        asp {
            label "Aspartic acid CG"
            color 3 # orange
            visible 0
            cutoff 0.075
        }
        ...
        glu {
            label "Glutamic acid CD"
            color 3 # orange
            visible 0
            cutoff 0.075
        }
        hsdn {
            label "Histidine(HSD) NE2"
            color 1 # red
            visible 0
            cutoff 0.075
        }
        hsdn2 {
            label "Histidine(HSD) ND1"
            color 0 # blue
            visible 0
            cutoff 0.075
        }
        hsen {
            label "Histidine(HSE) NE2"
            color 0 # blue
            visible 0
            cutoff 0.075
        }
        hsen2 {
            label "Histidine(HSE) ND1"
            color 1 # red
            visible 0
            cutoff 0.075
        }
        hsp {
            label "Histidine(HSP) NE2/ND1"
            color 0 # blue
            visible 0
            cutoff 0.075
        }
        ...
        met {
            label "Methionine C*/SD"
            color 7 # green
            visible 0
            cutoff 0.075
        }
        phe {
            label "Phenylalanine C*"
            color 7 # green
            visible 0
            cutoff 0.075
        }
    ...
    variable fragmaps_enabled {
        apolar hbdon hbacc mamn acec meoo tipo
        benc prpc forn foro dmeo iminh imin gehc
        flbx clbx brbx clex fetx tfec
